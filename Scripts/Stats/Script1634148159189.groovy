...
WebUI.click(findTestObject('Object Repository/Stats/Page_Blogger Stats/span_More about this blog'))

WebUI.click(findTestObject('Object Repository/Stats/Page_Blogger Blog Stats/path'))
